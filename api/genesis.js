...
Réponds UNIQUEMENT avec ce JSON valide, sans backticks :
{
  ...
  "reasoning_steps": ["Étape 1", "Étape 2", "GPT sélectionné — 88%"]
    ...
    let dec = {
      ...
      model: 'gpt', models: ['gpt'], reasoning_steps: []
    };
    try {
    ...
    if (selectedModels.length === 1) {
      ...
      return res.status(200).json({ text, models: selectedModels, claude_score: dec.claude_score, gpt_score: dec.gpt_score, gemini_score: dec.gemini_score, reasoning_steps: reasoningSteps });
    }
    ...
    if (available.length === 1) {
      return res.status(200).json({ text: results[available[0]], models: [available[0]], claude_score: dec.claude_score, gpt_score: dec.gpt_score, gemini_score: dec.gemini_score, reasoning_steps: reasoningSteps });
    }
    ...
    return res.status(200).json({ text: fusedText, models: available, claude_score: dec.claude_score, gpt_score: dec.gpt_score, gemini_score: dec.gemini_score, reasoning_steps: reasoningSteps });
