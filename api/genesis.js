...
${isFirstMessage ? `Tâche 2 — Nexo possède des IA expertes spécialisées. Détermine si cette question relève plutôt de l'une d'elles plutôt que de Genesis lui-même :
- sofia (Finance) : budget, épargne, dettes, investissements
- marcus (Droit du travail) : licenciement, arrêt maladie, contrat, employeur, salaire, prud'hommes
...
Genesis lui-même doit traiter : questions complexes/multi-domaines, demandes explicites adressées à Genesis, ou besoin explicite de comparer/combiner plusieurs IA.

action="redirect" si UN SEUL expert est clairement pertinent (confidence > 0.75).
action="ambiguous" si DEUX experts sont plausibles à confiance proche (donne expertId et expertId2).
action="answer" sinon (Genesis répond lui-même).
